...
# Setup default grid, overwritten by MQTT
width = 4
height = 4
...
while True:
    ...
    # Visualise accidents
    MQTT.publish_message("visualise/accidents", accidents)
    # Visualise cars
    coords = []
    for car in cars:
        coords.append([car.position[0], car.position[1], car.orientation])
    MQTT.publish_message("visualise/cars", coords)
